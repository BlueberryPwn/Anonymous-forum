...
namespace Anonymous_forum.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CommentId,CommentText,ThreadId")] Comments comments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommentId,CommentText,ThreadId")] Comments comments)
        {
